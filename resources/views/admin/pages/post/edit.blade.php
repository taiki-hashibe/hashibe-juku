        ...
        <x-admin.edit-form-row>
            ...
            <x-slot name="field">
                <x-admin.form.input type="text" name="line_link"
                    value="{{ old('line_link') ?? $item->line_link }}"></x-admin.form.input>
            </x-slot>
        </x-admin.edit-form-row>
        <x-admin.edit-form-row>
            ...
            <x-slot name="field">
                <x-admin.form.input type="datetime-local" name="public_release_at"
                    value="{{ old('public_release_at') ?? $item->public_release_at }}"></x-admin.form.input>
            </x-slot>
        </x-admin.edit-form-row>
        <x-admin.edit-form-row required>
            <x-slot name="label">タグ</x-slot>
            <x-slot name="field">
                <livewire:admin.post-tag-editor :selected="$item->tags" />
            </x-slot>
        </x-admin.edit-form-row>
