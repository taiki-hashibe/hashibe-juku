    ...
    <div class="mb-8">
        <x-gradation-container class="mb-24">
            <p class="text-slate-600 font-bold leading-relaxed mb-6">
                {{ config('app.name_short') }}に本入会いただくと...<br>
        ...
        <p class="mb-14">
            {{ config('app.name_short') }}には<span class="text-2xl font-bold">レッスン動画が無制限で見放題</span>以外にも、<br>
            たくさんの特典があります！
        </p>
        ...
        <p class="leading-relaxed mb-20">
            ...
            <br>
            {{ config('app.name_short') }}では<b>目標別のカリキュラムプレイリスト</b>を用意し、{{ isset($user) ? $user->name . 'さん' : 'あなた' }}の目標に合ったレッスン動画を効率よく見ることができます！
        </p>
        <x-gradation-badge>
            特典その２
        </x-gradation-badge>
        ...
        <p class="leading-relaxed mb-20">
            ...
            <br>
            {{ config('app.name_short') }}では、<b>レッスン動画をブックマーク</b>することができます。<br>
        ...
        <p class="leading-relaxed mb-20">
            {{ config('app.name_short') }}では、<b>受講完了した動画を登録</b>することができます。<br>
        ...
        <div class="mb-14">
            <p class="leading-relaxed mb-4">
                ...
                {{ config('app.name_short') }}は<b>コミュニティ</b>としての側面も大切にしており、ベース仲間と出会うこともできます！<br><br>
        ...
        <p class="leading-relaxed mb-20">
            {{ config('app.name_short') }}には、会員限定のコミュニティがあります。<br>
        ...
        <p class="mb-20">
            ...
            <br>
            しかし、僕の目指す{{ config('app.name_short') }}の内容は、<b>プロミュージシャンとして活動してきた経験</b>や、<b>専門学校でプロを育成してきた経験</b>を活かした<span
        ...
        <div class="mb-8" id="guidance-payment-form">
            ...
            <ul class="mb-8">
                <li>
                    ※{{ config('app.name_short') }}の決済方法はクレジットカードのみとなっております。
                </li>
                <li>
